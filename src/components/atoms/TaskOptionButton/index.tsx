...
import { toggleDeleteTask, toggleEditTask } from '@/store/EditModesSlice'
...
const TaskOptionButton: React.FC = () => {
    ...
    const toggleEditTaskModeFunction = () => {
    ...
    return (
        ...
        >
            <MenuItem
                className="my-[10px] rounded dark:hover:bg-dark-grey outline-none px-[10px] cursor-pointer text-black dark:text-white py-[6px]"
                onClick={toggleEditTaskModeFunction}
            >
                Edit Task
            </MenuItem>
            <MenuItem
